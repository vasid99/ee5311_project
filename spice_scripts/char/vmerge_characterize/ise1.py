...
t = T0 + T
i=0
critval_old = ~((stateout[0][i] & stateout[1][i]) | (stateout[1][i] & stateout[2][i]) | (stateout[2][i] & stateout[0][i]))
for i in range(1,len(stateout[0])):
	critval = ~((stateout[0][i] & stateout[1][i]) | (stateout[1][i] & stateout[2][i]) | (stateout[2][i] & stateout[0][i]))
